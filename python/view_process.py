#Interactively view process of MCMC chain samples
#This is now a front end for ptmcmc_analysis (with -selectX=False)
import argparse
...
ptmcmc_analysis.viewer(args.fname,selectX=False)
